...
{
    public class BurgerSection : RestaurantSection//انشئنا كلاس يرث من كلاس الاب المجرد (الابن الثاني) ويقوم باستخدام الميثودات المجردة
    {
        ...
        public BurgerSection() : base("Burger Section")//انشئنا كونستراكتر و يقوم بتمرير اسم القسم الى كلاس الاب ("Burger Section")
        {
            _menu = new MenuItem[]
            {
            new Burger("Beef Burger", 10, true),//نقوم بارسال اسم و سعر الوجبة واذا كان فيها جبنة ام لا
            new Burger("Chicken Burger", 8, false)
            };
